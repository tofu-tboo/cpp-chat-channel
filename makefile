...
server: src/server/server.cpp src/server/channel_server.cpp src/server/chat_server.cpp src/server/channel.cpp src/libs/util.cpp src/libs/json.cpp src/libs/json_parser.cpp | $(OUT_DIR)
	g++ $(CXXFLAGS) -o $(OUT_DIR)/$@ $^ $(PACKAGES)

server-simple: src/server/channel_server.cpp src/server/chat_server.cpp src/server/channel.cpp src/libs/util.cpp src/libs/json.cpp src/server/server_simple.cpp src/libs/json_parser.cpp | $(OUT_DIR)
	g++ $(CXXFLAGS) -o $(OUT_DIR)/$@ $^ $(PACKAGES)

libs: src/libs/util.cpp src/libs/json.cpp src/libs/task_runner.tpp src/libs/network_service.tpp src/libs/json_parser.cpp
